...
public class TestArea {
	...
	public TestArea(int size){
		...
		for (int i=1; i<arenasize-2; i++) {
			...
			arena[i][arenasize/2].tile[1][2] = 1;
			arena[i][arenasize/2+1].tile[1][0] = 1;		
		}
		
		//top left corners
		arena[1][1].tile[0][0] = 1;
		arena[1][arenasize/2+1].tile[0][0] = 1;
		//top right corners
		arena[1][arenasize-2].tile[0][2] = 1;
		arena[1][arenasize/2].tile[0][2] = 1;
		//bottom left corners
		arena[arenasize-2][1].tile[2][0] = 1;
		arena[arenasize-2][arenasize/2+1].tile[2][0] = 1;
		//bottom right corners
		arena[arenasize-2][arenasize-2].tile[2][2] = 1;
		arena[arenasize-2][arenasize/2].tile[2][2] = 1;
		
		//doors
		arena[arenasize/2][arenasize/2].tile[1][0] = 2;
		arena[arenasize/2][arenasize/2+1].tile[1][0] = 2;
